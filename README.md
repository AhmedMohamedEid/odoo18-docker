...
``` bash
curl -s https://raw.githubusercontent.com/AhmedMohamedEid/odoo18-docker/master/run.sh | sudo bash -s odoo-one 10018 20018
```

to set up first Odoo instance @ `localhost:10018` (default master password: `admin@123`)

and

``` bash
curl -s https://raw.githubusercontent.com/AhmedMohamedEid/odoo18-docker/master/run.sh | sudo bash -s odoo-two 11018 21018
```

to set up another Odoo instance @ `localhost:11018` (default master password: `admin@123`)
...
``` sh
$ git clone https://github.com/AhmedMohamedEid/odoo18-docker
